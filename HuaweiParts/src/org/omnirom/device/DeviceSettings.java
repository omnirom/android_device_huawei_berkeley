...
public class DeviceSettings extends PreferenceFragment implements
    ...
    private static final String KEY_FP_GESTURES = "fp_gestures_key";
    private static String FPNAV_ENABLED_PROP = "sys.fpnav.enabled";
    
    private static final String KEY_HIGH_TOUCH = "high_touch_key";
    private static final String HIGH_TOUCH_MODE = "/sys/touchscreen/touch_glove";
